  ...
  return (
    <Article id={id} title={title} tag={tag} color={color} update={update}>
      ...
      <Section>
        ...
        <P>
          個別指導塾のアルバイトを開始。人に勉強を教えるというのが面白く、その様子が塾長の目に留まったようで、半年ほどでそのままその塾の塾長として正社員に昇格。最初の3年ぐらいは仕事が楽しく、休みも返上して子供たちを教えることに熱中していました。しかし、受験が近くなると1日14時間、80連勤みたいなことを毎年行っていたことと、会社の売り上げノルマを達成するというのが精神的にも体力的にもきつくなり、このままではヤバいと思い退職。
        </P>
        <P>
          塾長時代に始めたアメーバブログがきっかけでweb制作に興味を持ちました。HTML、CSS、JavaScript、jQueryあたりをよく勉強していました。
        </P>
        <P>
      ...
      <Section>
        ...
        <P>
          コーダーとして入社しましたが、PHPでのプログラム部分もやってみたくWordPressではないPHPのプログラムについて独学。最終的にはフレームワークなどを用いずMySQLとPHPだけでCMSや会員サイトを作成する仕事をしていました。
        </P>
        <P>
