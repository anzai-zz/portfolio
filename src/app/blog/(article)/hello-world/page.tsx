  ...
  return (
    <Article id={id} title={title} tag={tag} color={color}>
      ...
      <Section>
        ...
        <P>個別指導塾のアルバイトを開始。人に勉強を教えるというのが面白く、その様子が塾長の目に留まったようで、そのままその塾の塾長として正社員に昇格。最初の3年ぐらいは仕事が楽しく、休みも返上して子供たちを教えることに熱中していました。受験が近くなると1日14時間、80連勤みたいなことを行いつつも、会社の売り上げノルマを達成するというのが精神的にも体力的にも年々きつくなり、このままではやばいと思い退職。</P>
